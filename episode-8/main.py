...
class Game:
	def __init__(self):
		self.config = gl.Config(double_buffer = True, major_version = 3, minor_version, depth_size = 16) # add depth_size = 16 because pyglet makes a 24 bit depth buffer by default, which isn't supported on some hardware
